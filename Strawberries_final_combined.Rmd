...
# make new level
all.NMDS.inoc$Water.TO.T1<-as.factor(ifelse(
              all.NMDS.inoc$TimePoint=="T1" & all.NMDS.inoc$Water=="1", "1",
                ifelse(all.NMDS.inoc$TimePoint=="T1" & all.NMDS.inoc$Water=="2", "2",
                  ifelse(all.NMDS.inoc$TimePoint=="T1" & all.NMDS.inoc$Water=="3", "3",
                    ifelse(all.NMDS.inoc$TimePoint=="T0" & all.NMDS.inoc$Water=="1", "0",
                      ifelse(all.NMDS.inoc$TimePoint=="T0" & all.NMDS.inoc$Water=="2", "0", "0"))))))
...
# plot
inoc1.trajectory<-ggplot(subset(all.NMDS.inoc, Inoculum %in% "1"),
                         aes(x=NMDS1,y=NMDS2,shape=factor(TimePoint),color=factor(Water))) + 
  ggtitle("Inoculum 1")+
  geom_point(aes(x=NMDS1,y=NMDS2,shape=factor(TimePoint),color=factor(Water))) +
  stat_ellipse(aes(x=NMDS1,y=NMDS2,color=factor(Water.TO.T1),linetype=factor(TimePoint)))+
...
#plot
inoc4.trajectory<-ggplot(subset(all.NMDS.inoc, Inoculum %in% "4"),
                         aes(x=NMDS1,y=NMDS2,shape=factor(TimePoint),color=factor(Water))) + 
  ggtitle("Inoculum 4")+
  geom_point(aes(x=NMDS1,y=NMDS2,shape=factor(TimePoint),color=factor(Water))) + 
  stat_ellipse(aes(x=NMDS1,y=NMDS2,color=factor(Water.TO.T1),linetype=factor(TimePoint)))+
...
# plot
inoc5.trajectory<-ggplot(subset(all.NMDS.inoc, Inoculum %in% "5"),
                         aes(x=NMDS1,y=NMDS2,shape=factor(TimePoint),color=factor(Water))) + 
  ggtitle("Inoculum 5")+
  geom_point(aes(x=NMDS1,y=NMDS2,shape=factor(TimePoint),color=factor(Water))) + 
  stat_ellipse(aes(x=NMDS1,y=NMDS2,color=factor(Water.TO.T1),linetype=factor(TimePoint)))+
...
# plot
inoc6.trajectory<-ggplot(subset(all.NMDS.inoc, Inoculum %in% "6"),
                         aes(x=NMDS1,y=NMDS2,shape=factor(TimePoint),color=factor(Water))) + 
  ggtitle("Inoculum 6")+
  geom_point(aes(x=NMDS1,y=NMDS2,shape=factor(TimePoint),color=factor(Water))) + 
  stat_ellipse(aes(x=NMDS1,y=NMDS2,color=factor(Water.TO.T1),linetype=factor(TimePoint)))+
