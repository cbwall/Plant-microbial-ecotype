...
prop.biomass.Inoc<-ggplot(longer_data,aes(Inoculum,response,fill=Inoculum)) +
  facet_wrap(.~Type)+
...
typeIIIModelshootpropem<-emmeans(typeIIIModelshootprop,pairwise~Inoculum|Water)
...
mta$Inoculum <- as.factor(mta$Inoculum)

#make the model
model1<-adonis2(otuTABtranspose~Water*Inoculum,data=mta,permutations=999,method="bray")
model1

mtapairwise<-unite(mta,c='water_inoculum',c('Water','Inoculum'),sep='-')
...
pair.mod.inoc<-pairwise.adonis(otuTABtranspose,
                          factors=c(mta$Inoculum))
pair.mod.inoc

# interaction pairwise
pair.mod.wat.inoc<-pairwise.adonis(otuTABtranspose,
                          factors=c(mtapairwise$water_inoculum))
pair.mod.wat.inoc
...
pair.mod<-pairwise.adonis(otuTABtranspose,factors=mtapairwise$water_inoculum)
pair.mod
...
data.scoresshoot$Inoculum <- shoots_post_stress$map_loaded$Inoculum
...
data.scoresroot$Inoculum <- roots_post_stress$map_loaded$Inoculum
...
Shoots.T1.NMDS<-ggplot(data=data.scoresshoot,
                  aes(x=NMDS1,y=NMDS2,shape=factor(Water),color=factor(Inoculum))) + 
  ...
  stat_ellipse(data=data.scoresshoot,aes(x=NMDS1,y=NMDS2,lty=factor(Water),color=factor(Inoculum)))+
...
Roots.T1.NMDS<-ggplot(data=data.scoresroot,
                      aes(x=NMDS1,y=NMDS2,shape=factor(Water),color=factor(Inoculum))) + 
  scale_color_brewer(palette="Dark2")+
  stat_ellipse(data=data.scoresroot,aes(x=NMDS1,y=NMDS2,lty=factor(Water),color=factor(Inoculum)))+
  scale_linetype_manual(values=c(1,2,3)) +
  ggtitle("Roots T1")+
...
inputshootsonlyminus2 =filter_data(inputshootsonly, 'Inoculum', filter_vals = '2')
inputshootsonlyminus3 =filter_data(inputshootsonlyminus2, 'Inoculum', filter_vals = '3')
...
data.time$Inoculum <- finalNMDSmovement$map_loaded$Inoculum
...
finalNMDSmovement$map_loaded$Inoculum<-as.factor(finalNMDSmovement$map_loaded$Inoculum)
finalNMDSmovement$map_loaded$TimeWater <- paste(finalNMDSmovement$map_loaded$TimePoint,finalNMDSmovement$map_loaded$Water)
finalNMDSmovement$map_loaded$TimeInoculum <- paste(finalNMDSmovement$map_loaded$TimePoint,finalNMDSmovement$map_loaded$Inoculum)
...
inocfinalvf <- envfit(time.mds~TimeInoculum, data=finalNMDSmovement$map_loaded, perm = 999)
...
####
NMDS1.mean.data.inoc<-aggregate(NMDS1~ Inoculum*TimePoint, data=data.time, FUN=mean)
NMDS2.mean.data.inoc<-aggregate(NMDS2~ Inoculum*TimePoint, data=data.time, FUN=mean)
centroid.data.inoc<-as.data.frame(cbind(NMDS1.mean.data.inoc, NMDS2.mean.data.inoc[3]))


timeinoculation<-ggplot(data=data.time,
                        aes(x=NMDS1,y=NMDS2,color=factor(Inoculum),shape=factor(TimePoint))) + 
  scale_color_brewer(palette="Dark2")+ 
  ggtitle("Inoculum")+
  geom_point(data=data.time,aes(x=NMDS1,y=NMDS2,color=factor(Inoculum),shape=factor(TimePoint)), alpha=0.8) + # add the point markers
...
model2<-adonis2(otuTABtranspose~Inoculum*TimePoint,data=mta,permutations=999,method="bray")
model2
model4<-adonis2(otuTABtranspose~Inoculum*TimePoint,data=mta,permutations=999,method="jaccard")
model4
```
...
data.time$Inoculum<-as.factor(data.time$Inoculum)
```
...
Shoots.T0.NMDS<-ggplot(data=data.time,aes(x=NMDS1,y=NMDS2,color=factor(Inoculum))) + 
  ggtitle("T0 Shoots")+
  scale_color_brewer(palette="Dark2")+
  geom_point(data=data.time,
             aes(x=NMDS1,y=NMDS2,shape=factor(Water),color=factor(Inoculum)), alpha=0.8) + 
  stat_ellipse(data=data.time,aes(x=NMDS1,y=NMDS2,color=factor(Inoculum)))+
  theme(
    axis.text = element_text(color='black',size=10),
    axis.title = element_text(color='black',size=12),
    axis.ticks = element_line(color='black'),
...
inoc1.trajectory<-ggplot(data=data.scoresinoc1,aes(x=NMDS1,y=NMDS2,shape=factor(TimePoint),color=factor(Water))) + 
  ...
  geom_segment(aes(x = centroid.inoc1[1,3], xend = centroid.inoc1[4,3], 
                   y = centroid.inoc1[1,4], yend = centroid.inoc1[4,4]),arrow = arrow(), colour = "paleturquoise3") +
  geom_segment(aes(x = centroid.inoc1[2,3], xend = centroid.inoc1[5,3], 
                   y = centroid.inoc1[2,4], yend = centroid.inoc1[5,4]),arrow = arrow(), colour = "steelblue2") +
  geom_segment(aes(x = centroid.inoc1[3,3], xend = centroid.inoc1[6,3], 
                   y = centroid.inoc1[3,4], yend = centroid.inoc1[6,4]),arrow = arrow(), colour = "skyblue4") +
  theme(
    axis.text = element_text(color='black',size=10),
    axis.title = element_text(color='black',size=12),
    axis.ticks = element_line(color='black'),
...
inoc4.trajectory<-ggplot(data=data.scoresinoc4,aes(x=NMDS1,y=NMDS2,shape=factor(TimePoint),color=factor(Water))) + 
  ...
  geom_segment(aes(x = centroid.inoc4[4,3], xend = centroid.inoc4[1,3], 
                   y = centroid.inoc4[4,4], yend = centroid.inoc4[1,4]),arrow = arrow(), colour = "paleturquoise3") +
  geom_segment(aes(x = centroid.inoc4[5,3], xend = centroid.inoc4[2,3], 
                   y = centroid.inoc4[5,4], yend = centroid.inoc4[2,4]),arrow = arrow(), colour = "steelblue2") +
  geom_segment(aes(x = centroid.inoc4[6,3], xend = centroid.inoc4[3,3], 
                   y = centroid.inoc4[6,4], yend = centroid.inoc4[3,4]),arrow = arrow(), colour = "skyblue4") +
  theme(
    axis.text = element_text(color='black',size=10),
    axis.title = element_text(color='black',size=12),
    axis.ticks = element_line(color='black'),
...
inoc5.trajectory<-ggplot(data=data.scoresinoc5,aes(x=NMDS1,y=NMDS2,shape=factor(TimePoint),color=factor(Water))) + 
  ...
  geom_segment(aes(x = centroid.inoc5[4,3], xend = centroid.inoc5[1,3], 
                   y = centroid.inoc5[4,4], yend = centroid.inoc5[1,4]),arrow = arrow(), colour = "paleturquoise3") +
  geom_segment(aes(x = centroid.inoc5[5,3], xend = centroid.inoc5[2,3], 
                   y = centroid.inoc5[5,4], yend = centroid.inoc5[2,4]),arrow = arrow(), colour = "steelblue2") +
  geom_segment(aes(x = centroid.inoc5[6,3], xend = centroid.inoc5[3,3], 
                   y = centroid.inoc5[6,4], yend = centroid.inoc5[3,4]),arrow = arrow(), colour = "skyblue4") +
  theme(
    axis.text = element_text(color='black',size=10),
    axis.title = element_text(color='black',size=12),
    axis.ticks = element_line(color='black'),
...
inoc6.trajectory<-ggplot(data=data.scoresinoc6,aes(x=NMDS1,y=NMDS2,shape=factor(TimePoint),color=factor(Water))) + 
  ...
  geom_segment(aes(x = centroid.inoc6[4,3], xend = centroid.inoc6[1,3], 
                   y = centroid.inoc6[4,4], yend = centroid.inoc6[1,4]),arrow = arrow(), colour = "paleturquoise3") +
  geom_segment(aes(x = centroid.inoc6[5,3], xend = centroid.inoc6[2,3], 
                   y = centroid.inoc6[5,4], yend = centroid.inoc6[2,4]),arrow = arrow(), colour = "steelblue2") +
  geom_segment(aes(x = centroid.inoc6[6,3], xend = centroid.inoc6[3,3], 
                   y = centroid.inoc6[6,4], yend = centroid.inoc6[3,4]),arrow = arrow(), colour = "skyblue4") +
  theme(
    axis.text = element_text(color='black',size=10),
    axis.title = element_text(color='black',size=12),
    axis.ticks = element_line(color='black'),
...
inocalone
ggsave("figures/Fig3.T0T1 inoc.wa vector.pdf", height=8, width=10)
...
# Water 1 stats
```{r}
water1model<-lm(shannon~type*inoculum,shanfinalbindt1water1)
Anova(water1model,type=3)

posthoc.1<-emmeans(water1model,pairwise~inoculum|type)
#posthoc with letters
multcomp::cld(posthoc.1, Letters=letters)

posthoc.2<-emmeans(water1model,pairwise~type|inoculum)
multcomp::cld(posthoc.2, Letters=letters)
...
# Water 2 stats
```{r}
water2model<-lm(shannon~type*inoculum,shanfinalbindt1water2)
Anova(water2model,type=3)
emmeans(water2model,pairwise~inoculum|type)
emmeans(water2model,pairwise~type|inoculum)
```

# Water 3 stats
```{r}
water3model<-lm(shannon~type*inoculum,shanfinalbindt1water3)
Anova(water3model,type=3)
emmeans(water3model,pairwise~inoculum|type)
emmeans(water3model,pairwise~type|inoculum)
```
