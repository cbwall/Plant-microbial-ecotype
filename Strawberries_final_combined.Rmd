...
input3 =filter_data(input2, 'Inoculum', filter_vals = '3') #1379 ASVs
...
#prune 0 counts
phy.straw.drop.0<-prune_taxa(taxa_sums(phy.straw)> 0, phy.straw)
