...
#write.csv(otuTAB.all, "output/otuTAB.all.csv")
```
...
```{r}
library(ggthemes)
shootsfamily<-ggplot(familyshootfinalbind, aes(x = inoculum, y = value, fill = family)) + 
