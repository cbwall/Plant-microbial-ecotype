...
strawb_miseq_map$Sample_or_Control[strawb_miseq_map$Inoculation == "6"] <- "Control Trt"
...
NMDS.pips1 = plot_ordination(ps.pips, GP.ord, type="samples", color="Inoculation", shape = "Water", title="Bray-Cutis community dissimilarities for all replicates")
...
#write this to .csv
pips_complete <- write.csv(pips_complete, "data/pips_data/pips_complete.csv")
```
...
#---------
#run PERMANOVA water
adonis_water = adonis2(ps.pips.bray ~ Water, data = sampledf)
print(adonis_water)
...
# with main effects
adonis_combo = adonis2(ps.pips.bray ~ Inoculation + Water, 
...
#run PERMANOVA for inoculation and water
# with interaction 
adonis_combo_int = adonis2(ps.pips.bray ~ Inoculation * Water, permutations = 9999, 
                       data = sampledf, method = "bray")
